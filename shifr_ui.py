...
class Ui_Encryptor(object):
    def setupUi(self, Encryptor):
        ...
        self.line.setGeometry(QtCore.QRect(130, 0, 20, 591))
        ...
        self.but_polibiy.setGeometry(QtCore.QRect(10, 460, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.but_book.setGeometry(QtCore.QRect(10, 370, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.but_thritemius = QtWidgets.QRadioButton(self.centralwidget)
        self.but_thritemius.setGeometry(QtCore.QRect(10, 520, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        self.but_thritemius.setFont(font)
        self.but_thritemius.setStyleSheet("color: rgb(192, 249, 255);")
        self.but_thritemius.setObjectName("but_thritemius")
        self.but_couples = QtWidgets.QRadioButton(self.centralwidget)
        self.but_couples.setGeometry(QtCore.QRect(10, 430, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.but_rotors.setGeometry(QtCore.QRect(10, 490, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.but_homophonic.setGeometry(QtCore.QRect(10, 400, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.but_gronsfeld = QtWidgets.QRadioButton(self.centralwidget)
        self.but_gronsfeld.setGeometry(QtCore.QRect(10, 310, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        self.but_gronsfeld.setFont(font)
        self.but_gronsfeld.setStyleSheet("color: rgb(192, 249, 255);")
        self.but_gronsfeld.setObjectName("but_gronsfeld")
        self.but_replace = QtWidgets.QRadioButton(self.centralwidget)
        self.but_replace.setGeometry(QtCore.QRect(10, 340, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.but_caesar.setGeometry(QtCore.QRect(10, 550, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
    ...
    def retranslateUi(self, Encryptor):
        ...
        self.but_atbash.setText(_translate("Encryptor", "Атбаш"))
        self.but_vishener.setText(_translate("Encryptor", "Виженера"))
        self.but_vernam.setText(_translate("Encryptor", "Вернама"))
        self.but_affine.setText(_translate("Encryptor", "Афинский"))
        self.but_bacon.setText(_translate("Encryptor", "Бэкона"))
        self.but_polibiy.setText(_translate("Encryptor", "Полибия"))
        self.but_book.setText(_translate("Encryptor", "Книжный"))
        self.but_thritemius.setText(_translate("Encryptor", "Тритемиуса"))
        self.but_couples.setText(_translate("Encryptor", "Парами"))
        self.but_rotors.setText(_translate("Encryptor", "Роторный"))
        self.but_homophonic.setText(_translate("Encryptor", "Омофонический"))
        self.but_gronsfeld.setText(_translate("Encryptor", "Гронсфельда"))
        self.but_replace.setText(_translate("Encryptor", "Замены"))
